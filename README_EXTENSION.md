...
```shell
  docker buildx build -t egekocabas/mailhog:latest . --load
```
...
```shell
  docker extension dev reset egekocabas/mailhog:latest
```
...
```shell
docker extension update egekocabas/mailhog:latest
```
...
```shell
docker extension rm egekocabas/mailhog:latest
```
